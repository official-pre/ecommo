  ...
  return (
    <div className="w-[80%] mx-auto flex flex-col items-center justify-center gap-5">
      ...
      <section className="w-[75%] flex flex-col items-center justify-center mt-10 bg-zinc-300 px-16 border-2 border-black rounded-lg shadow-br py-10">
        <img className="w-32 h-32 object-cover rounded-full mb-8" src="https://img.freepik.com/premium-photo/3d-illustration-cartoon-character-avatar-profile_1183071-123.jpg" alt="" />
        ...
        <h2 className="text-xl font-semibold">Deendyal Singh</h2>
        <h3 className="text-sm">Founder of Skin Maker</h3>
