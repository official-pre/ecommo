      ...
      <section className="w-1/2 h-full flex flex-col items-center gap-5 pt-10">
        ...
        <section className="space-y-2 px-16 py-10 rounded-md border-2 bg-zinc-300 border-black shadow-upper-shadow">
          <h4 className="text-md font-semibold">
            45,Gaurav Tower, Malviya Nagar <br /> Jaipur, Rajasthan <br /> 302017.
          </h4>
          <h4 className="text-md font-semibold"> Call us : +91 864*****68</h4>
          <h4 className="text-md font-semibold"> Mail us : skin.maker@gmail.com</h4>
          <section className="">
